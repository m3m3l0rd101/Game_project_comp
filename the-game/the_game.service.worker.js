...
/** @type {string} */
const CACHE_VERSION = '1773961463|8330223709';
/** @type {string} */
const CACHE_PREFIX = 'the_game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'the_game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["the_game.html","the_game.js","the_game.offline.html","the_game.icon.png","the_game.apple-touch-icon.png","the_game.audio.worklet.js","the_game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["the_game.wasm","the_game.pck","the_game.side.wasm"];
